...
class Target(nn.Module):
    def __init__(self):
        ...
        self.fc_1 = nn.Linear(in_features=32, out_features=2) # for eveyrthing before 2fiii
        # self.fc_1 = nn.Linear(in_features=256, out_features=2) # for 2fiii
    ...
    def forward(self, x):
        ...
        output = self.fc_1(flattened)

        return output
        # print(output.shape)
        # print(f'predictions:{predictions(output)}')
